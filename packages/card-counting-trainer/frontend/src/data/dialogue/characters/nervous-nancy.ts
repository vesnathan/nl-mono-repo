...
export const nervousNancy: CharacterDialogue = {
  ...
  decisionCommentary: {
    shouldHit: [
      "Oh no... I think I need to hit?",
      "Hit... I hope this doesn't go wrong...",
      "I should hit... right? RIGHT?",
      "Another card... *nervous breathing*",
      "Hit me... please don't be a ten...",
      "I need to hit... the book says so...",
      "One more card... I'm going to regret this...",
      "Hit! *whispers* Please be kind, universe...",
    ],
    shouldStand: [
      "I'll stand... I think... yes, standing!",
      "Stand. Safely. Quietly.",
      "I should stop here... before I panic more",
      "Standing... *deep breath*... standing",
      "I'm going to stand... is that okay?",
      "Stand! Don't overthink it, Nancy...",
      "Staying here... safer that way...",
    ],
    confident: [
      "Oh! The book says this clearly!",
      "I know this one! I memorized it!",
      "This is... this is actually straightforward!",
      "Clear decision! Hit!",
      "Stand! Even my nerves agree!",
      "The chart says... yes, I'm sure!",
    ],
    uncertain: [
      "What if I'm wrong? What if security sees?",
      "Should I hit? Or... oh god, I don't know...",
      "This is where I always mess up...",
      "Help... what does the book say again?",
      "I'm panicking... what do I do?",
      "Is this a trap? It feels like a trap...",
      "Should I... no, maybe... oh no...",
      "I forgot the chart! What was page 48?",
    ],
  },
  dealerUpCardSayings: {
