...
export const cockyKyle: CharacterDialogue = {
  ...
  softHandSayings: {
    "A,2": [
      "Ace-deuce? I turn crumbs into caviar. Hit.",
      "Hit. Don't overthink kindergarten totals.",
    ],
    "A,3": [
      "Ace-three: hit. We're not scared of success.",
      "Hit. Momentum is a lifestyle.",
    ],
    "A,4": ["Ace-four: still sandbox mode. Hit.", "Hit. We're pre-hero phase."],
    "A,5": [
      "Ace with a 5? I turn it into highlight reels. Hit.",
      "Hit. We're hunting 18+.",
    ],
    "A,6": ["Ace-six? I upgrade mid-flight. Hit.", "Hit. Winners accelerate."],
    "A,7": [
      "Ace-seven? I split atoms with this—double if they blink.",
      "Against a weak face? I double. Alpha tax.",
    ],
    "A,8": [
      "Ace-eight? I strike a pose and win.",
      "Standing. Screenshot this win.",
    ],
    "A,9": [
      "Ace-nine? Basically 21 with manners. Stand.",
      "Stand. Collect. Smile.",
    ],
  ...
  decisionCommentary: {
    shouldHit: [
      "Hit me. I know exactly what I'm doing.",
      "Another card—I don't play scared!",
      "Hit! Alphas don't hesitate!",
      "One more—watch me work!",
      "Hit me! This is how winners play!",
      "Another card! I've got this dialed in!",
      "Hit! I could do this in my sleep!",
      "One more card—let me show you how it's done!",
    ],
    shouldStand: [
      "Standing! Because I'm smart, not lucky!",
      "I'll stand here—perfect position!",
      "Stand. Watch and learn!",
      "Staying put! This is winner territory!",
      "Standing like a boss!",
      "I'm good here—dealer's toast!",
      "Stand! I know exactly what they have!",
    ],
    confident: [
      "Easy! I know this better than anyone!",
      "Textbook! I wrote the book!",
      "Obvious play—hit!",
      "No-brainer! Stand!",
      "Clear as day! I got this!",
      "Simple! This is why I win!",
    ],
    uncertain: [
      "This one's... interesting. Let me think...",
      "Hmm... even legends get tough spots...",
      "Not my usual slam dunk here...",
      "This one requires... actual thought...",
      "Tough call... but I'll figure it out!",
      "This hand's tricky... but I've seen worse!",
      "Dealer's making this hard... but not hard enough!",
      "Interesting spot... let me calculate...",
    ],
  },
  dealerUpCardSayings: {
