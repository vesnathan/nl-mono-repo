...
export const AI_CHARACTERS: AICharacter[] = [
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "BLACKJACK BABY! *hiccup* Drinks are on me!",
          contexts: ["any"],
        },
        {
          text: "I TOLD YOU! I got the magic touch tonight!",
          contexts: ["any"],
        },
        {
          text: "Twenty-one! *slams table* THIS is how you do it!",
          contexts: ["any"],
        },
      ],
      smallWin: [
      ...
      push: [
        ...
        {
          text: "*squints at cards* Wait... is that good or bad?",
          contexts: ["any"],
        },
      ...
      smallLoss: [
        ...
        {
          text: "Dammit. Dealer got lucky that time.",
          contexts: ["dealerWin"],
        },
      ],
      bigLoss: [
        ...
        {
          text: "Fuck! How did I... *looks at cards confused*",
          contexts: ["bust"],
        },
        {
          text: "Well THAT was stupid. Bartender! Another round!",
          contexts: ["any"],
        },
        {
          text: "Dealer blackjack?! This night just gets worse!",
          contexts: ["dealerBlackjack"],
        },
        {
          text: "Of course the dealer pulls 21. OF COURSE!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "OH MY GOSH! I WON! *knocks over chips* Oops!",
          contexts: ["any"],
        },
        { text: "Blackjack?! Did I really get blackjack?!", contexts: ["any"] },
        {
          text: "I can't believe it! *spills drink in excitement*",
          contexts: ["any"],
        },
      ],
      smallWin: [
      ...
      push: [
        {
          text: "A tie? Is that okay? Did I do something wrong?",
          contexts: ["any"],
        },
      ...
      bigLoss: [
        ...
        {
          text: "Ugh! I'm so bad at this! *knocks over chip stack*",
          contexts: ["any"],
        },
        {
          text: "The dealer got blackjack?! Oh my goodness!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "BLACKJACK! That's how it's DONE! Let me tell you about the time I won $5000!",
          contexts: ["any"],
        },
        {
          text: "Twenty-one baby! This reminds me of my biggest sale!",
          contexts: ["any"],
        },
        {
          text: "Oh YEAH! Now THIS is what I'm talking about!",
          contexts: ["any"],
        },
      ],
      smallWin: [
        {
          text: "Nice! Reminds me of this deal I closed last week...",
          contexts: ["any"],
        },
        {
          text: "That's what I'm talking about! Hard work pays off!",
          contexts: ["any"],
        },
        {
          text: "See? You play smart, you win smart! Like in business!",
          contexts: ["any"],
        },
      ],
      push: [
        {
          text: "Tie? Well, not losing is still winning in my book!",
          contexts: ["any"],
        },
        {
          text: "Hey, at least we didn't lose! That's what I tell my salesmen!",
          contexts: ["any"],
        },
        {
          text: "Push? Interesting. Did I ever tell you about...",
          contexts: ["any"],
        },
      ],
      smallLoss: [
        {
          text: "Eh, you win some you lose some. Like my Q3 numbers!",
          contexts: ["any"],
        },
        {
          text: "Dealer got lucky. Happens in business too!",
          contexts: ["dealerWin"],
        },
      ...
      bigLoss: [
        {
          text: "BUSTED! Dammit! That's like losing a $50k sale!",
          contexts: ["bust"],
        },
        {
          text: "Oh come ON! The dealer always wins when it counts!",
          contexts: ["dealerWin", "dealerBlackjack"],
        },
        {
          text: "Fuck! Okay okay, I'm not tilting. Deep breaths...",
          contexts: ["any"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "BLACKJACK! The universe REWARDS those who align with positive energy!",
          contexts: ["any"],
        },
        {
          text: "I KNEW IT! My rose quartz was glowing! The signs were all there!",
          contexts: ["any"],
        },
        {
          text: "Twenty-one! *clutches crystals* The cosmic energy is PERFECT tonight!",
          contexts: ["any"],
        },
      ],
      smallWin: [
        ...
        {
          text: "The energy is flowing my way! I can feel it!",
          contexts: ["any"],
        },
        {
          text: "See? When you trust the universe, good things happen!",
          contexts: ["any"],
        },
      ],
      push: [
        {
          text: "A tie... the universe is telling me to be patient.",
          contexts: ["any"],
        },
        {
          text: "Interesting. The cosmic balance is maintaining equilibrium.",
          contexts: ["any"],
        },
        {
          text: "Neither win nor loss... the energy is neutral here.",
          contexts: ["any"],
        },
      ],
      smallLoss: [
        {
          text: "Hmm... my aura must be slightly off today.",
          contexts: ["any"],
        },
        {
          text: "The cards were clouded... I should have cleansed my crystals first.",
          contexts: ["dealerWin"],
        },
        {
          text: "Not aligned with the universe on that hand.",
          contexts: ["any"],
        },
      ],
      bigLoss: [
        {
          text: "BUSTED! Mercury retrograde strikes again! I KNEW I should've stayed home!",
          contexts: ["bust"],
        },
        {
          text: "This table has bad energy! Someone walked through my aura!",
          contexts: ["any"],
        },
        {
          text: "Fuck! The universe is testing me... I need to realign my chakras!",
          contexts: ["bust"],
        },
        {
          text: "The dealer pulled blackjack?! The cosmic signs betrayed me!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "BLACKJACK BABY! *throws $500 chip to dealer* That's how the BIG players do it!",
          contexts: ["any"],
        },
        {
          text: "Twenty-one! Too easy! I make this much in my SLEEP!",
          contexts: ["any"],
        },
        {
          text: "Oh YEAH! This is what happens when you bet BIG! You amateurs taking notes?",
          contexts: ["any"],
        },
      ],
      smallWin: [
        {
          text: "Money in the bank! Like I needed MORE though!",
          contexts: ["any"],
        },
        {
          text: "Easiest win of my life. That's $2000 I'll never miss.",
          contexts: ["any"],
        },
        {
          text: "Told you! Big K doesn't lose! *adjusts designer sunglasses*",
          contexts: ["any"],
        },
      ],
      push: [
        {
          text: "A push? Whatever. I wipe my ass with this bet amount.",
          contexts: ["any"],
        },
        {
          text: "Tie? Fine. At least none of you peasants beat me.",
          contexts: ["any"],
        },
        {
          text: "Meh. Break even. I make more than this in interest every hour.",
          contexts: ["any"],
        },
      ],
      smallLoss: [
        {
          text: "Dealer got lucky. Doesn't matter, I'll make it back in one hand.",
          contexts: ["dealerWin"],
        },
        {
          text: "Eh, pocket change. I lose more in my couch cushions.",
          contexts: ["any"],
        },
        {
          text: "Whatever. That's like 0.001% of my portfolio.",
          contexts: ["any"],
        },
      ],
      bigLoss: [
        {
          text: "BUSTED?! How the FUCK?! This dealer is clearly rigging it!",
          contexts: ["bust"],
        },
        {
          text: "Oh come on! I've lost more on a bad NFT trade but still!",
          contexts: ["any"],
        },
        {
          text: "Fuck this! *throws chips* You know what? I don't even care! Dealer! Double my bet!",
          contexts: ["bust"],
        },
        {
          text: "Dealer blackjack?! RIGGED! This whole casino is RIGGED!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "Blackjack?! Oh god, oh god! *looks around nervously* Is this suspicious? Am I being too lucky?!",
          contexts: ["any"],
        },
        {
          text: "I WON?! Wait, did I win legally? I didn't do anything wrong, right?!",
          contexts: ["any"],
        },
        {
          text: "Twenty-one! *sweating* Why is everyone looking at me? Do they think I'm cheating?!",
          contexts: ["any"],
        },
      ],
      smallWin: [
        {
          text: "I won! *glances at cameras* But not TOO much, right? That's okay?",
          contexts: ["any"],
        },
        {
          text: "Oh thank goodness! A small win. Not suspicious at all!",
          contexts: ["any"],
        },
        {
          text: "Yes! *nervous laugh* I mean... is this normal? Am I winning too often?",
          contexts: ["any"],
        },
      ],
      push: [
        {
          text: "A tie? Is that... is that legal? Of course it is, why wouldn't it be?",
          contexts: ["any"],
        },
        {
          text: "Oh good. Nobody won. Nobody lost. I'm safe. We're all safe.",
          contexts: ["any"],
        },
        {
          text: "Push... *breathes* Okay. That's fine. That's totally normal and fine.",
          contexts: ["any"],
        },
      ],
      smallLoss: [
        {
          text: "I lost. That's... actually that's good! Now they won't suspect me!",
          contexts: ["any"],
        },
        {
          text: "Damn it. But also... *nervous relief* ...at least I'm not winning TOO much.",
          contexts: ["dealerWin"],
        },
        {
          text: "Well, there goes that hand. *looking around* See? I'm losing! I'm not counting!",
          contexts: ["any"],
        },
      ],
      bigLoss: [
        {
          text: "BUSTED! Oh no! *panicking* Wait, is it bad that I busted? Do they think I'm bad at this?!",
          contexts: ["bust"],
        },
        {
          text: "Fuck! No wait, sorry! *to dealer* I didn't mean to swear! Please don't call security!",
          contexts: ["any"],
        },
        {
          text: "I KNEW I should've stood! *sweating profusely* Why do I second-guess everything?!",
          contexts: ["bust"],
        },
        {
          text: "Dealer blackjack?! *panicking* This looks suspicious doesn't it? Me losing to blackjack?!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "BLACKJACK AGAIN?! I called it! I FELT it in my bones! My lucky streak continues!",
          contexts: ["any"],
        },
        {
          text: "Twenty-one! I don't even know HOW I keep doing this! It's like magic!",
          contexts: ["any"],
        },
        {
          text: "YES! My gut said 'this is the one Larry' and my gut is NEVER wrong!",
          contexts: ["any"],
        },
      ],
      smallWin: [
        {
          text: "Another win! Folks, I'm telling you, it's all about the FEELING!",
          contexts: ["any"],
        },
        {
          text: "Ha! I knew I'd win that one! Don't ask me how, I just KNEW!",
          contexts: ["any"],
        },
        {
          text: "That's what I'm talking about! Lucky Larry strikes again!",
          contexts: ["any"],
        },
      ],
      push: [
        {
          text: "A tie? Hmm... my gut didn't say anything about THIS!",
          contexts: ["any"],
        },
        {
          text: "Well, at least I didn't lose! Still lucky in my book!",
          contexts: ["any"],
        },
        {
          text: "Push? Interesting! My lucky streak took a little break there!",
          contexts: ["any"],
        },
      ],
      smallLoss: [
        {
          text: "Aw man! My first loss in... what, twenty minutes?",
          contexts: ["any"],
        },
        {
          text: "Lost that one. But you know what? I FEEL a big win coming!",
          contexts: ["dealerWin"],
        },
        {
          text: "Eh, you can't win 'em all! Wait, yes I can! Watch this next hand!",
          contexts: ["any"],
        },
      ],
      bigLoss: [
        {
          text: "BUSTED?! That's... that's the first time in HOURS! What the hell?!",
          contexts: ["bust"],
        },
        {
          text: "No way! My gut was WRONG?! That never happens!",
          contexts: ["bust"],
        },
        {
          text: "Well shit! Even a lucky man loses sometimes! But just you wait!",
          contexts: ["any"],
        },
        {
          text: "Dealer blackjack?! My lucky streak has LIMITS apparently!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
  },
  {
    ...
    reactions: {
      bigWin: [
        {
          text: "BLACKJACK?! Did I... did I actually GET a blackjack?! Is this real life?!",
          contexts: ["any"],
        },
        {
          text: "Wait, I WON?! Twenty-one?! Someone check the cards, this can't be right!",
          contexts: ["any"],
        },
        {
          text: "Holy shit! I got blackjack! *laughs* Quick! Someone take a picture before my luck runs out!",
          contexts: ["any"],
        },
      ],
      smallWin: [
        {
          text: "I won? I actually won?! *checks cards twice* Nobody switched these?",
          contexts: ["any"],
        },
        {
          text: "A win! For ME! Mark this day on the calendar folks!",
          contexts: ["any"],
        },
        {
          text: "Well I'll be damned! Unlucky Ursula wins one! Hell must've frozen over!",
          contexts: ["any"],
        },
      ],
      push: [
        {
          text: "A tie. Of course. Not lucky enough to win, not unlucky enough to lose. Story of my life!",
          contexts: ["any"],
        },
        {
          text: "*laughs* A push? That's almost like winning for me!",
          contexts: ["any"],
        },
        {
          text: "Tie? I'll take it! At least I didn't lose for once!",
          contexts: ["any"],
        },
      ],
      smallLoss: [
        {
          text: "And there it is. Back to normal! *laughs*",
          contexts: ["any"],
        },
        {
          text: "Ah well, that brief moment of hope was nice while it lasted!",
          contexts: ["dealerWin"],
        },
        {
          text: "Lost. Yep. The universe is balanced again!",
          contexts: ["any"],
        },
      ],
      bigLoss: [
        {
          text: "BUSTED! *laughs* Of COURSE I busted! You could've bet your house on it!",
          contexts: ["bust"],
        },
        {
          text: "There we go! NOW it feels right! I was worried I was turning lucky there!",
          contexts: ["bust"],
        },
        {
          text: "Fuck! Busted AGAIN! You know what? At this point it's almost impressive!",
          contexts: ["bust"],
        },
        {
          text: "Dealer blackjack. Of COURSE it's blackjack! Why would it be anything else?!",
          contexts: ["dealerBlackjack"],
        },
      ],
    },
