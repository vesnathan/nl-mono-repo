...
export interface CharacterDialogueAddons {
  ...
  banterWithPlayer?: string[]; // directed at other players (incl. human)
...
export const AI_DIALOGUE_ADDONS: CharacterDialogueAddons[] = [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "You counting? I’m discounting.",
      "Buddy, if I win, we win. That’s friendship math.",
      "Swap seats? Mine’s haunted by bad decisions.",
      "Advice? Never trust even numbers. Or odd ones.",
      "You got a system? I got a symptom.",
      "Hold my drink—no don’t, I’ll lose track of both.",
    ],
    banterWithDealer: [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "If I knock anything of yours, I replace it!",
      "Tell me if I’m in your space—I do that.",
      "You look composed. Teach me your ways!",
      "What’s your system? Mine is ‘don’t drop things’.",
      "We’re in this together—me and my apologies.",
      "I’ll cheer loudly… but softly.",
    ],
    banterWithDealer: [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "You play often? What’s your conversion rate?",
      "I celebrate your wins—rising tide stuff.",
      "You count? I count cars. Fair trade.",
      "Your table presence says ‘ops manager’.",
      "Need a pep talk? I’ve got a catalog.",
      "We’re co-pilots. You call the turbulence.",
    ],
    banterWithDealer: [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "Your calm helps the table flow.",
      "May I place this crystal near you?",
      "If you join mid-shoe, bless it first?",
      "I celebrate your win—it raises all boats.",
      "Your laugh just broke the bad pattern.",
      "Want a mini sage spray? It’s gentle.",
    ],
    banterWithDealer: [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "You learning? Watch closely.",
      "I’ll sponsor your win with my aura.",
      "We can be friends if you root for me.",
      "Counting? Boring. I brand the moments.",
      "You bring strategy, I bring spectacle.",
      "Smile—this is content.",
    ],
    banterWithDealer: [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "If I seem weird, I promise I’m nice.",
      "You look confident—can I borrow some?",
      "If I win big, will you stand in front of me?",
      "I’ll celebrate you loudly… in a whisper.",
      "If you need space, I’ll shrink. Like this.",
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "Stick close; it rubs off.",
      "Call a hand—I’ll vibe check it.",
      "You ever surfed a heater? Grab a board.",
      "If I cool off, I buy coffees.",
      "Your smile added three percent to odds.",
      "We’re all lucky tonight—promise.",
    ],
    banterWithDealer: [
  ...
  // -------------------------------------------------
  {
    ...
    banterWithPlayer: [
      "Sit by me; I absorb the bad beats.",
      "If I sigh, it’s melodic—enjoy.",
      "Your luck looks radiant. Leech away.",
      "I’m here to make your stats look good.",
      "If I win, we’ll name it a miracle.",
      "Advice? Expect the opposite of me.",
    ],
    banterWithDealer: [
