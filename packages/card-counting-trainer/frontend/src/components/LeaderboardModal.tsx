...
export default function LeaderboardModal({
  ...
  const mockData: Record<string, LeaderboardEntry[]> = {
    "current-chips": [
      { rank: 1, username: "CardShark87", value: 125000, patreonTier: "PLATINUM" },
    ...
    "peak-chips": [
      ...
      { rank: 2, username: "CardShark87", value: 187000, patreonTier: "PLATINUM" },
      { rank: 3, username: "VegasVet", value: 165000, patreonTier: "GOLD" },
      { rank: 4, username: "CountMaster", value: 142000, patreonTier: "SILVER" },
    ...
    "longest-streak": [
      ...
      { rank: 5, username: "ConsistentCarl", value: 376, patreonTier: "BRONZE" },
    ],
    "high-score": [
      { rank: 1, username: "ScoreChampion", value: 10485750, patreonTier: "PLATINUM" },
      { rank: 2, username: "PointMaster", value: 5242870, patreonTier: "GOLD" },
      { rank: 3, username: "CardShark87", value: 2621430, patreonTier: "PLATINUM" },
      { rank: 4, username: "HighScorer", value: 1310710, patreonTier: "SILVER" },
        ...
        >
          ...
          >
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: "12px", color: "#AAA", marginBottom: "4px" }}>Current Chips</div>
              <div style={{ fontSize: "20px", fontWeight: "bold", color: "#4CAF50" }}>
                {currentChips.toLocaleString()}
              </div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: "12px", color: "#AAA", marginBottom: "4px" }}>Peak Chips</div>
              <div style={{ fontSize: "20px", fontWeight: "bold", color: "#FFD700" }}>
                {peakChips.toLocaleString()}
              </div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: "12px", color: "#AAA", marginBottom: "4px" }}>Longest Streak</div>
              <div style={{ fontSize: "20px", fontWeight: "bold", color: "#FF6B6B" }}>
                {longestStreak}
              </div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: "12px", color: "#AAA", marginBottom: "4px" }}>High Score</div>
              ...
              {categories.map((cat) => (
                <button
                  ...
                  style={{
                    ...
                    border: "2px solid",
                    borderColor:
                      selectedCategory === cat.id ? "#FFF" : "rgba(255, 255, 255, 0.2)",
                    borderRadius: "10px",
                    padding: "10px 20px",
                    fontSize: "14px",
