...
+(function (a) {
  ...
  +(function (a) {
    ...
    (c.VERSION = "3.3.1"),
      ...
      (c.prototype.enter = function (b) {
        var c =
          b instanceof this.financeor
            ? b
            : a(b.currentTarget).data("bs." + this.type);
        return c && c.$tip && c.$tip.is(":visible")
          ? void (c.hoverState = "in")
          : (c ||
              ((c = new this.financeor(
                b.currentTarget,
  ...
  +(function (a) {
    ...
    (c.VERSION = "3.3.1"),
      (c.DEFAULTS = a.extend({}, a.fn.tooltip.financeor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
        template:
      ...
      (c.prototype = a.extend({}, a.fn.tooltip.financeor.prototype)),
      (c.prototype.financeor = c),
      (c.prototype.getDefaults = function () {
        return c.DEFAULTS;
      }),
      (c.prototype.setContent = function () {
