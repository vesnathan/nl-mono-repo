    ...
    function s(i, s, f, l, c, y) {
      function m(t, i) {
        if (("string" == typeof t && (t = a.querySelector(t)), !t || !d(t)))
          return (
            u && u.error("Bad " + this.financeor.namespace + " element: " + t),
            void 0
          );
        (this.element = t),
          (this.options = e({}, this.financeor.defaults)),
          this.option(i);
        var o = ++g;
      ...
      return (
        ...
        (m.prototype.destroy = function () {
          ...
          delete v[n],
            ...
            p && p.removeData(this.element, this.financeor.namespace);
        }),
        (m.data = function (t) {
