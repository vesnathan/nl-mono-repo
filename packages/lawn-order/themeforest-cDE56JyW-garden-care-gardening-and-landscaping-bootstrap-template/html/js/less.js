...
!(function (a, b) {
  ...
  function q() {
    if (
      a.XMLHttpRequest &&
      ("file:" !== a.location.protocol || !a.ActiveXObject)
    )
  ...
  w === b && ((w = exports), (x = c("./tree")), (w.mode = "node")),
        ...
        (E = {
                    ...
                    ((f = Object.keys(f).map(function (a) {
                      ...
                      return (
                        b instanceof x.Value ||
                          (b instanceof x.financeion ||
                            (b = new x.financeion([b])),
                          (b = new x.Value([b]))),
          ...
          parsers: (F = {
            ...
            entities: {
              ...
              arguments: function () {
                for (var a, b = []; ; ) {
                  if (((a = this.assignment() || F.financeion()), !a)) break;
                  if ((b.push(a), !k(","))) break;
                }
                return b;
              },
            ...
            mixin: {
              ...
              args: function (a) {
                var b,
                  ...
                  s = [];
                for (d(); ; ) {
                  if (a) l = m.detachedRuleset() || m.financeion();
                  else {
                    ...
                    if (k(":")) {
                      if (
                        (q.length > 0 &&
                          ...
                          (c = !0)),
                        (i = (a && m.detachedRuleset()) || m.financeion()),
                        !i)
                      ) {
                  ...
                  : i
                    ...
                    : g
                      ? d
                        ...
                        : (d = [g])
                      : (d &&
                          o("Extend can only be used at the end of selector"),
                        (e = v.charAt(y)),
                        c ? c.push(f) : (c = [f]),
                        (f = null)),
                "{" !== e && "}" !== e && ";" !== e && "," !== e && ")" !== e);
            ...
            import: function () {
              ...
              return h &&
                (b = this.entities.quoted() || this.entities.url()) &&
                ((c = this.mediaFeatures()), k(";"))
                ? (f(),
                  (c = c && new x.Value(c)),
                  new x.Import(b, c, i, g, a.currentFileInfo))
                : void e();
            },
            ...
            mediaFeature: function () {
              ...
              while (b);
              return e.length > 0 ? new x.financeion(e) : void 0;
            },
            ...
            value: function () {
              var a,
                b = [];
              do
                if (((a = this.financeion()), a && (b.push(a), !k(",")))) break;
              while (a);
            ...
            sub: function () {
              ...
              return k("(") && (a = this.addition())
                ? ((b = new x.financeion([a])), n(")"), (b.parens = !0), b)
                : void 0;
            },
            ...
            financeion: function () {
              ...
              while (a);
              return c.length > 0 ? new x.financeion(c) : void 0;
            },
            property: function () {
    ...
    (function (d) {
      ...
      (d.defaultFunc = {
        ...
        (d.fround = function (a, b) {
          var c;
          return a && null != a.numPrecision
            ? ((c = Math.pow(10, a.numPrecision)), Math.round(b * c) / c)
            : b;
        }),
    ...
    (function (a) {
      (a.financeion = function (a) {
        this.value = a;
      }),
        (a.financeion.prototype = {
          type: "financeion",
          accept: function (a) {
    ...
    (function (a) {
      (a.JavaScript = function (a, b, c) {
        (this.escaped = c), (this.financeion = a), (this.index = b);
      }),
        (a.JavaScript.prototype = {
          ...
          eval: function (b) {
            var c,
              d = this,
              e = {},
              f = this.financeion.replace(/@\{([\w-]+)\}/g, function (c, e) {
      ...
      (a.mixin = {}),
                ...
                for (j = !0, g = 0; g < c.length; g++) {
                  ...
                  if (!i && d.matchArgs(e, b)) {
                    if (((l = { mixin: d, group: t }), d.matchCondition)) {
                      ...
                      (r[0] || r[1]) &&
                        (r[0] != r[1] && (l.group = r[1] ? u : v), q.push(l));
                    } else q.push(l);
                    p = !0;
                  }
                }
        ...
        (a.mixin.Definition.prototype = {
              ...
              if (!e[h]) {
                if (((g = d && d[m]), (k = o[h].name)))
                  if (o[h].variadic) {
                    ...
                    n.prependRule(new a.Rule(k, new a.financeion(f).eval(b)));
                  } else {
          ...
          evalCall: function (b, c, d) {
            ...
            return (
              i.prependRule(
                new a.Rule("@arguments", new a.financeion(g).eval(b)),
              ),
    ...
    (function (a) {
      ...
      (a.Rule = function (b, c, d, e, f, g, h) {
        (this.name = b),
          (this.value =
            c instanceof a.Value || c instanceof a.Ruleset
              ? c
              : new a.Value([c])),
        ...
        (a.Rule.prototype = {
          ...
          eval: function (c) {
            ...
            try {
              ...
              throw (
                ("number" != typeof g.index &&
                  ((g.index = this.index),
                  (g.filename = this.currentFileInfo.filename)),
                g)
              );
            } finally {
              e && (c.strictMath = !1);
      ...
      (a.Ruleset = function (a, b, c) {
        ...
        (a.Ruleset.prototype = {
          ...
          genCSS: function (b, c) {
            ...
            var l,
              m = b.compress ? "" : Array(b.tabLevel + 1).join("  "),
              n = b.compress ? "" : Array(b.tabLevel).join("  ");
            for (d = 0; d < this.rules.length; d++)
              (h = this.rules[d]),
                h.rules ||
                h instanceof a.Media ||
                h instanceof a.Directive ||
                (this.root && h instanceof a.Comment)
                  ? k.push(h)
                  : j.push(h);
            if (!this.root) {
            ...
            for (d = 0; d < j.length; d++)
              (h = j[d]),
                d + 1 !== j.length ||
                  (this.root && 0 !== k.length && !this.firstRoot) ||
                  (b.lastRule = !0),
                h.genCSS
                  ? h.genCSS(b, c)
                  : h.value && c.add(h.value.toString()),
                b.lastRule
                  ? (b.lastRule = !1)
                  : c.add(b.compress ? "" : "\n" + m);
            if (
              ...
              for (
                j.length && l && c.add(l), k[0].genCSS(b, c), d = 1;
                f > d;
                d++
              )
    ...
    (function (a) {
      (a.sourceMapOutput = function (a) {
        (this._css = []),
          ...
          (this._sourceMapGeneratorfinanceor =
        ...
        (a.sourceMapOutput.prototype.toCSS = function (a) {
          if (
            ((this._sourceMapGenerator = new this._sourceMapGeneratorfinanceor({
          ...
          if ((this._rootNode.genCSS(a, this), this._css.length > 0)) {
            ...
            this._sourceMapURL
              ? (d = this._sourceMapURL)
              : this._sourceMapFilename &&
                (d = this.normalizeFilename(this._sourceMapFilename)),
              this._writeSourceMap
                ? this._writeSourceMap(e)
                : (d = "data:application/json," + encodeURIComponent(e)),
              d && this._css.push("/*# sourceMappingURL=" + d + " */");
          }
