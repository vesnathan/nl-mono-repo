(function (e, t, n) {
  ...
  e.attr = function (t, r, s, o) {
    ...
    if (r === "type" && s !== n && l.test(t.nodeName)) {
    ...
    if (!e.attrHooks[a] && h.test(a)) {
      ...
      if (p.test(a)) {
        i("jQuery.fn.attr(" + a + ") may use property instead of attribute");
      }
    }
      ...
      if (r) {
        a = function (e) {
          if (!e.type || b.test(e.type)) {
            return s
              ? s.push(e.parentNode ? e.parentNode.removeChild(e) : e)
              : r.appendChild(e);
          }
        };
