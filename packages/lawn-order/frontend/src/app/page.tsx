...
export default function HomePage() {
  const services = [
    { icon: "mdi:lawn-mower", title: "Lawn Mowing", description: "Professional mowing to keep your rental property looking pristine for guest arrivals" },
    { icon: "mdi:grass", title: "Whipper Snippering", description: "Neat edges and hard-to-reach areas for that professional finish" },
    { icon: "mdi:tree", title: "Ground Level Pruning", description: "Keep shrubs and hedges tidy and guest-ready" },
    { icon: "mdi:delete-variant", title: "Garden Waste Removal", description: "Complete cleanup and removal of all garden waste" },
    { icon: "mdi:home-roof", title: "Gutter Cleaning", description: "Prevent water damage and maintain your property's condition" },
    { icon: "mdi:water-pump", title: "Pressure Washing", description: "Clean driveways, paths, and outdoor areas to impress your guests" },
  ];
        ...
        <section className="py-20 w-full">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl font-bold mb-2 font-josefin text-white">About Tommy's Law'n Order</h2>
              ...
              <p className="mb-8 font-roboto-slab text-gray-200 leading-relaxed">
                Tommy's carers are qualified horticulturalists and 4.98★ rated Airbnb hosts who understand exactly what your rental property needs to get those 5-star reviews.
              </p>
              <div className="grid grid-cols-2 gap-3 max-w-2xl mx-auto">
                <div className="flex items-center gap-2 justify-center">
                  <i className="text-brand-green text-lg">✓</i>
                  <span className="font-roboto-slab text-sm text-white">Qualified Horticulturalists</span>
                </div>
                <div className="flex items-center gap-2 justify-center">
                  <i className="text-brand-green text-lg">✓</i>
                  <span className="font-roboto-slab text-sm text-white">4.98★ Airbnb Hosts</span>
                </div>
                <div className="flex items-center gap-2 justify-center">
                  <i className="text-brand-green text-lg">✓</i>
                  <span className="font-roboto-slab text-sm text-white">Local to Devonport</span>
                </div>
                <div className="flex items-center gap-2 justify-center">
                  <i className="text-brand-green text-lg">✓</i>
                  <span className="font-roboto-slab text-sm text-white">Reliable Service</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4 font-josefin">Our Services</h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-6 font-roboto-slab">
              Everything you need to keep your Airbnb, Booking.com, and VRBO rental property looking perfect for every guest arrival in the Devonport area.
            </p>
            ...
            {services.map((service, index) => (
              <div key={index} className="text-center animate-fadeInUp mb-8">
                ...
                <div className="w-32 h-32 rounded-full border-4 border-gray-300 flex items-center justify-center mx-auto mb-6 hover:border-brand-green transition-colors bg-white">
                  <Icon icon={service.icon} className="w-16 h-16 text-brand-green" />
                </div>
                {/* Title */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-left mb-12">
                ...
                <p className="text-gray-200 font-roboto-slab leading-relaxed">
                  We understand the unique needs of Airbnb, Booking.com, and VRBO hosts. Your property needs to look perfect for every guest arrival.
                </p>
              </div>

              <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  { icon: "✓", title: "Backed by 4.98★ Airbnb Hosts", desc: "Tommy's carers are experienced hosts who understand what your property needs" },
                  { icon: "✓", title: "Qualified Horticulturalists", desc: "Professional expertise ensuring proper care from people who know plants" },
                  { icon: "✓", title: "Local to Devonport", desc: "Servicing postcodes 7310 & 7306 - we're your local neighbours" },
                  { icon: "✓", title: "Supporting Meaningful Employment", desc: "Tommy is building his future through honest work" },
                  ...
                  <div key={index} className="flex gap-3 items-start">
                    ...
                    <div>
                      <h6 className="font-bold text-white mb-1 font-roboto-slab">{item.title}</h6>
                      <p className="text-gray-200 text-sm font-roboto-slab leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
