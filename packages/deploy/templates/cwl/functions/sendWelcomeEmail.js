 ...
 *
 * Generated: 2025-10-08T12:39:09.015Z
 */
    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let s of m(e))
        !h.call(o, s) &&
          ...
          i(o, s, {
            get: () => e[s],
            enumerable: !(a = p(e, s)) || a.enumerable,
          });
    return o;
  };
var b = (o) => y(i({}, "__esModule", { value: !0 }), o);
var E = {};
g(E, { handler: () => C });
module.exports = b(E);
var r = require("@aws-sdk/client-ses"),
  v = new r.SESClient({ region: process.env.AWS_REGION || "ap-southeast-2" }),
  x = process.env.FROM_EMAIL || "noreply@cloudwatchlive.com",
  f = process.env.APP_URL || "https://cloudwatchlive.com",
  C = async (o) => {
    console.log("Sending welcome email to:", o.userEmail);
    let { userEmail: e, userFirstName: t, userLastName: a, userId: s } = o,
      c = `${f}/login?userId=${s}`,
      l = `
    <!DOCTYPE html>
    <html>
  ...
  `,
      u = new r.SendEmailCommand({
        ...
        Message: {
          ...
          Body: {
            Html: { Data: l, Charset: "UTF-8" },
            Text: { Data: d, Charset: "UTF-8" },
          },
        },
      });
    try {
      let n = await v.send(u);
      return (
        console.log("Email sent successfully:", n.MessageId),
        {
          statusCode: 200,
          body: JSON.stringify({
