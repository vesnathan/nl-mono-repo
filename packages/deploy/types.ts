...
export interface DeploymentOptions {
  ...
  export interface DeploymentOptions {
    ...
    export const TEMPLATE_PATHS: Record<StackType, string> = {
      ...
      [StackType.AwsExample]: join(__dirname, "templates/aws-example/cfn-template.yaml"),
      [StackType.MyStoryForge]: join(__dirname, "templates/my-story-forge/cfn-template.yaml"),
    };
