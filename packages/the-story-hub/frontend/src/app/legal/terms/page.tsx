      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-800 space-y-6">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-[#21271C] mt-6 mb-3">
              2.1 What This Means:
            </h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Attribution (BY):</strong> You must give appropriate
                credit to the original authors.
              </li>
              <li>
                <strong>Non-Commercial (NC):</strong> You may not use the
                content for commercial purposes or profit-making activities.
              </li>
              <li>
                <strong>No Derivatives (ND):</strong> You may not modify, remix,
                or create derivative works from the content without explicit
                permission.
              </li>
            </ul>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#21271C] mt-8 mb-4">
              3. Prohibition Against Scraping and Automated Access
            </h2>
            <p>
              <strong>Strictly Prohibited:</strong> The following activities are
              expressly forbidden:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Automated scraping, crawling, or harvesting of content</li>
              <li>
                Use of bots, spiders, or automated tools to access the Platform
              </li>
            ...
            <p className="mt-4">
              <strong>Consequences:</strong> Violation of this prohibition may
              result in:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              By submitting content to The Story Hub (stories, chapters,
              comments, etc.):
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>You retain copyright ownership of your original content</li>
              <li>
                You grant The Story Hub a license to display and distribute your
                content on the Platform
              </li>
              <li>
                You agree that your content will be licensed under CC BY-NC-ND
                4.0
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, The Story Hub and its
          ...
          <section className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mt-8">
            ...
            <p className="text-gray-800">
              <strong>Commercial Use is Strictly Prohibited.</strong> If you
              wish to use any content for commercial purposes, you must obtain
              explicit written permission from both The Story Hub and the
        ...
        <div className="mt-12 pt-8 border-t border-gray-300">
          <p className="text-gray-600 text-center">
            By using The Story Hub, you acknowledge that you have read,
