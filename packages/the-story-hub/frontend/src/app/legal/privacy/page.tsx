      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-800 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Content:</strong> Stories, chapters, comments, votes you
                submit
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Usage Data:</strong> Pages viewed, time spent, features
                used
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Provide Services:</strong> Enable account functionality,
                display content, process interactions
              </li>
              <li>
                <strong>Improve Platform:</strong> Analyze usage patterns, fix
                bugs, develop features
              </li>
              <li>
              ...
              <li>
                <strong>Security:</strong> Prevent fraud, abuse, and
                unauthorized access
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Public Content:</strong> Stories, chapters, comments,
                and profiles are publicly visible
              </li>
              <li>
                <strong>Service Providers:</strong> Third-party services that
                help operate the Platform (hosting, analytics, email)
              </li>
              <li>
              ...
              <li>
                <strong>Safety:</strong> To protect rights, property, or safety
                of The Story Hub, users, or public
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mt-4">
              To exercise these rights, contact us through the Platform or email
              us at privacy@thestoryhub.com (if applicable).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              other than your own. By using the Platform, you consent to such
              transfers. We take steps to ensure your data receives adequate
              protection.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Platform or sending an email. Your continued use after changes
          ...
          <section>
            ...
            <p>
              ...
              practices, please contact us through the Platform or at
              privacy@thestoryhub.com.
            </p>
          </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-300">
          <p className="text-gray-600 text-center">
            By using The Story Hub, you acknowledge that you have read and
