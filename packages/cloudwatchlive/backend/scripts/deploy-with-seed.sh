...
# Deploy CWL with Database Seeding
# This script deploys the CWL infrastructure and optionally seeds the database
...
echo -e "${BLUE}🚀 CWL Deployment with Database Seeding${NC}"
echo ""
...
echo ""
echo -e "${GREEN}🎉 CWL Deployment Complete!${NC}"
echo ""
