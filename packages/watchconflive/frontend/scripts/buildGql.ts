...
import { execCommandAsPromise } from "../../../sharedScripts/execCommandAsPromise";
import { mergeGraphqlFiles } from "../../../sharedScripts/mergeGraphqlFiles";
...
const buildGql = async () => {
  ...
  const command = `npx amplify codegen types`;
