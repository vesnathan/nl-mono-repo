...
import { z } from "zod";
import { AWSEUser } from "./gqlTypes";

export const createEmptyAWSEUser = (): AWSEUser => ({
  __typename: "AWSEUser",
  userId: uuidv4(),
  userEmail: "",
  userTitle: "",
...
export const AWSEUserSchema = z.object({
...
export const AWSEUserFormValidationSchema = AWSEUserSchema.superRefine(
  (val, ctx) => {
