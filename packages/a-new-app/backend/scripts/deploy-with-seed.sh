...
# Deploy ANA with Database Seeding
# This script deploys the ANA infrastructure and optionally seeds the database
...
echo -e "${BLUE}🚀 ANA Deployment with Database Seeding${NC}"
echo ""
...
echo ""
echo -e "${GREEN}🎉 ANA Deployment Complete!${NC}"
echo ""
