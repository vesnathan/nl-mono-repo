...
const triggerClassnames = [
  ...
  // due to unable to set same border-error on ANATextField,
...
export type ANASelectOption<T extends string = string> = {
  id: T;
  value: React.ReactNode;
  textValue?: string;
};

export interface ANASelectProps<T extends string = string> {
  id?: string;
  testId?: string;
...
export function ANASelect<T extends string>(props: ANASelectProps<T>) {
  const {
    id,
    testId,
    label,
